...
To identify candidate repositories for our study, we performed a keyword-based search over public GitHub code using the [GitHub Search API](https://docs.github.com/en/rest/search?apiVersion=2022-11-28). We designed an expanded list of 30+ LLM-related keywords targeting common APIs, prompt engineering patterns, and framework imports, such as:
...
The complete code for this data collection process is documented in [`../src/data_sourcing.ipynb`](../src/data_sourcing.ipynb).

---

Let me know if you also want a section for data limitations or next steps!
