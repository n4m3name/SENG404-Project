...
This metadata was merged with our keyword-matching dataset (see [../data/combined_repository_data.csv](https://github.com/n4m3name/SENG404-Project/blob/master/data/combined_repository_data.csv)), creating a unified view of prompt relevance and project health. The merged data is saved in both `.csv` and `.json` format to support both manual review and downstream analysis.
